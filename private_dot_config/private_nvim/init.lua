...
-- Enable mouse mode, can be useful for resizing show can i open a terminal window on the right side in neovimplits for example!
vim.o.mouse = 'a'
...
-- change to different project, needs tmux
...
-- paste and delete over selection without overwriting clipboard
vim.keymap.set('x', '<leader>p', [["_dP]])
vim.keymap.set({ 'n', 'v' }, '<leader>d', [["_d]])

-- copy to system clipboard and entire line
